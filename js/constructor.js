jQuery(function ($) {
    ...
    $(document).ready(function () {
        ...
        $('.constr-wrap').on('mouseover', '.help-icon', function () {
            $(this).parents('.group-btn-box').find('.tooltip').fadeIn();
        });
        $('.constr-wrap').on('mouseout', '.help-icon', function () {
            $(this).parents('.group-btn-box').find('.tooltip').fadeOut();
        });
        ...
        $('.save-answers-group').on('click', function () {
            ...
            if (text) {
                if (groupAnwers.length > 200) {
                    ...
                    let itemsList = thisQuestion.find('.answer-row-content');
        ...
        function addSingleOption(questionId, pointId, text, itemsList, addClas = ' ') {
            ...
            let itemHtml =
                `<div class="answer-row sortable">
                    <div class="radio-item single-question-item ${addClas}">
                        <div class="remove-item"></div>
                        <textarea name="${itemsName}" rows="1" placeholder="Вариант ответа">${text}</textarea>
                    </div>
                    <div class="action-select-item single-question-select">
                        <select name="" class="customselect">
                            <option selected disabled>Действия</option>
                            <option value="Перейти к странице">Перейти к странице</option>
                            <option value="Закончить опрос">Закончить опрос</option>
                            <option value="Исключить респондента">Исключить респондента</option>
                            <option value="Скрыть вопрос">Скрыть вопрос</option>
                            <option value="Показать вопрос">Показать вопрос</option>
                            <option value="Скрыть страницу">Скрыть страницу</option>
                            <option value="Показать страницу">Показать страницу</option>
                        </select>
                    </div>
                    <div class="select-item single-question-select">
                        <select name="" class="customselect">
        ...
        function setSortbaleSingleItems() {
            let questionList = $('.question-single .answer-row-content');
